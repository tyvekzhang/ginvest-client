...
import { useReportProfitCycle } from '@/service/report-income-statement'
...
export default function DetailPage() {
  ...
  const { profitCycleList } = useReportProfitCycle(stock_code, timePeriod)
    ...
    <div className="min-h-full bg-white p-4">
      <div className="max-w-[1400px] mx-auto">
        ...
        {loading ? (
          ...
          <Card>
            <h2 className="text-xl font-bold mb-2">净利润与同比增长率趋势图</h2>
            <div className="w-full h-[400]">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={profitCycleList} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                  <XAxis dataKey="cycle" />
                  <YAxis
                    yAxisId="left"
                    label={{ value: "净利润 (亿)", angle: -90, position: "insideLeft" }}
                    stroke="#4a5565"
                  />
                  <YAxis
                    yAxisId="right"
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar yAxisId="left" dataKey="net_profit" fill="#3b82f6" name="净利润 (亿)" />
                  <Line
                    yAxisId="right"
                    type="monotone"
